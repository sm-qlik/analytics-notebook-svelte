...
<div class="relative">
	...
	{#if isOpen}
		...
		>
			...
			<!-- Logout and Clear Data Button -->
			{#if onLogoutAndClearData}
				<div class="py-1.5 border-t border-gray-100 dark:border-gray-700">
					<button
						type="button"
						onclick={() => {
							isOpen = false;
						...
						class="w-full text-left px-4 py-2.5 text-sm text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors flex items-center gap-2.5"
					>
						<svg
